...
<!-- Chamando o DataTable por cdn e traduzindo também por cdn -->
		...
		<div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row" style="margin-top: 0px">
                    ...
                    <div class="col-md-6" style="margin-bottom: 5px">
                        <span><b>nivel: </b></span><span id="nivel_dados"></span>
                    </div>
                    <div class="col-md-6" style="margin-bottom: 5px">
...
<script type="text/javascript">
    ...
    }// fecha a função listarPermissoes
    ...
    }// fecha a função adicionarPermissao
    ...
    }// fecha a função adicionarPermissoes
    ...
    }// fecha a função limparPermissoes
</script>