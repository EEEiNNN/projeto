...
<head>
	...
	<!-- Códigos Datatables->Downloads->CDN -->
	<link href="https://cdn.datatables.net/v/dt/dt-2.3.1/datatables.min.css" type="text/css" rel="stylesheet" integrity="sha384-euvbLDizNhjdB+SK/Ai+GY3WCCHaDJM1tnnh2IqvUY9zjhlo21JkywSg8X5hlMY8" crossorigin="anonymous">
			...
			<div class="modal-body">
					...
					<div class="row">
						...
						<div class="col-md-4">							
								...
								<input type="password" class="form-control" id="conf_senha_perfil" name="senha" placeholder="Confirmar Senha" value="<?php echo $senha_usuario ?>" required>							
						</div>
					</div>
					...
					<div class="row">
						<div class="col-md-4">							
								...
								<input type="text" class="form-control" id="endereco_perfil" name="endereco" placeholder="Endereço" value="<?php echo $endereco_usuario ?>" required>							
						</div>
						<div class="col-md-4">							
								<label>Foto</label>
